...
# 5. PRINCIPAL COMPONENT ANALYSIS AND DECISION TREE MODELLING
# A. DATA PREPARATION FOR PCA
...
# C. ANALYZING VARIANCE EXPLAINED
...
# D. PCA PROJECTION AND CLUSTER ANALYSIS
data.pca$x
...
# E. ADVANCED PCA USING FactoMineR for a more detailed analysis after prcomp
